...
//                    System.out.println("nigga");
    ...
    private void startNewDay() {
        ...
        for (Player player : App.getCurrentGame().getPlayers()) {
            ...
            int threshold = (int) Math.ceil(chanceOfKalag / 16);
            ...
            if (threshold >= 4) {
                ...
                shouldRemove = rand.nextFloat() < 0.75f; // 75%
            } else if (threshold >= 2) {
                shouldRemove = rand.nextFloat() < 0.5f; // 50%
            } else if (threshold >= 1) {
                shouldRemove = rand.nextFloat() < 0.25f; // 25%
            }
...
//    }
    ...
    public Result cheatAddItem(String name, int count) {
        ...
        if (ForagingSeedsEnums.isContain(name)) {
            ...
            addItem = true;
        } else if (name.equalsIgnoreCase("mixedseeds")) {
...
//                    }
    ...
    public static void checkSkilRecipe() {
        ...
        //MinersTreat
        if (currentPlayer.getExtractionSkill().getLevel() >= 150) {
            boolean cr1 = false;
            for (Cookingrecipe cookingrecipe : currentPlayer.getCookingRecipes()) {
